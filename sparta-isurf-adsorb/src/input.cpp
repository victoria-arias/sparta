	  ...
	  *ptr2 = '\0';
	  if (strchr(ptr1,'*')) {
		...
		if (mode == 0 && modify->compute[icompute]->vector_flag) {
		  ...
		  expandflag = 1;
		  //cout << "nmax is col size of compute global vector" << endl;
		} else if (mode == 1 && modify->compute[icompute]->array_flag) {
		  nmax = modify->compute[icompute]->size_array_cols;
		  expandflag = 1;
		  //cout << "nmax is col size of compute global array" << endl;
		  ...
		  expandflag = 1;
		  //cout << "nmax is col size of compute per-particle array" << endl;
		  ...
		  expandflag = 1;
		  //cout << "nmax is col size of compute per-grid array" << endl;
		  ...
		  expandflag = 1;
		  // cout << "nmax is col size of compute per-surf array" << endl;
		}
	      }	
